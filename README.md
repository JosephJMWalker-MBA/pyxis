...
## Current status — through Milestone 49A / D246
...
The detailed narrative below remains the original central proof trail through **Milestone 18C / D137** and is intentionally preserved rather than rewritten wholesale. For current orientation, continue through [`docs/CURRENT_FRONTIER.md`](docs/CURRENT_FRONTIER.md), [`docs/CURRENT_FRONTIER_35_36.md`](docs/CURRENT_FRONTIER_35_36.md), [`docs/CURRENT_FRONTIER_37_38.md`](docs/CURRENT_FRONTIER_37_38.md), [`docs/CURRENT_FRONTIER_39_40.md`](docs/CURRENT_FRONTIER_39_40.md), [`docs/CURRENT_FRONTIER_41_43.md`](docs/CURRENT_FRONTIER_41_43.md), [`docs/CURRENT_FRONTIER_44.md`](docs/CURRENT_FRONTIER_44.md), [`docs/MILESTONE_44H.md`](docs/MILESTONE_44H.md), [`docs/MILESTONE_45A.md`](docs/MILESTONE_45A.md), [`docs/MILESTONE_45B.md`](docs/MILESTONE_45B.md), [`docs/CURRENT_FRONTIER_46.md`](docs/CURRENT_FRONTIER_46.md), and [`docs/CURRENT_FRONTIER_48.md`](docs/CURRENT_FRONTIER_48.md), then [`docs/MILESTONE_49A.md`](docs/MILESTONE_49A.md). Milestone-specific records, implementation, tests, and executed CI remain stronger authority than any compact summary.
...
13. [`docs/MILESTONE_49A.md`](docs/MILESTONE_49A.md) — D246, durable exact-range selection without a note: canonical file-local persistence of explicit paragraph/range coordinates over durable capture identity; this is the current implemented frontier.

49A returns development to a concrete researcher action. Its next distinct boundary is explicit relinking of one freshly verified 49A selection sidecar to one caller-supplied matching loaded capture. Do not collapse that source-attachment proof into file-local verification, source discovery, fuzzy re-anchoring, or citation authority.
