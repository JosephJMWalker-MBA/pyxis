...
@pytest.mark.asyncio
async def test_50r_existing_47f_product_persists_bare_third_basis_as_overlay_v2(
    tmp_path: Path,
) -> None:
    ...
    async with shell.run_test(size=(250, 1040)) as pilot:
        await pilot.pause()
        ...
        destination = tmp_path / "50r-ui-third-basis.overlay.json"
        shell.query_one(
